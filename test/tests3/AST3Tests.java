...
public class AST3Tests {
    ...
    public void testReportIncremented() {
        ...
        assertEquals("# Numerical Literals: 1\n" +
                ...
                "# Plus Expressions: 0\n" +
                "# Sequences: 0",   nf.report());
        nf.makePlusExp(nf.makeNumericLiteral(1), nf.makeStringLiteral("a"));
        assertEquals("# Numerical Literals: 2\n" +
                ...
                "# Sequences: 0",   nf.report());
        nf.makeVarExp("x");
        nf.makeDeclarative("y");
        nf.makeAssignment("a", nf.makeNumericLiteral(1));
        assertEquals("# Numerical Literals: 3\n" +
                ...
                "# Plus Expressions: 1\n" +
                "# Sequences: 0",   nf.report());
        nf.makeSequence(nf.makeVarExp("y"), nf.makeStringLiteral("Marley"));
        assertEquals("# Numerical Literals: 3\n" +
                "# String Literals: 2\n" +
                "# Assignments: 1\n" +
                "# Declaratives: 1\n" +
